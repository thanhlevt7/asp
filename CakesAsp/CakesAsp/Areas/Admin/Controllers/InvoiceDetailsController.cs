...
namespace CakesAsp.Areas.Admin.Controllers
{
    ...
    public class InvoiceDetailsController : Controller
    {
        ...
        public InvoiceDetailsController(CakesAspContext context)
        {
            _context = context;
        }
        ...
        {
            var cakesAspContext = _context.InvoiceDetails.Include(i => i.Invoice).Include(i => i.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,InvoiceId,ProductId,Quantity,Total")] InvoiceDetail invoiceDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InvoiceId,ProductId,Quantity,Total")] InvoiceDetail invoiceDetail)
        {
